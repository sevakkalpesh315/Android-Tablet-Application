...
public class BalloonOverlay extends FrameLayout {
	...
	public BalloonOverlay(Context context, int balloonBottomOffset) {
		...
		video = (TextView) v.findViewById(R.id.balloon_item_video);
		call = (TextView) v.findViewById(R.id.balloon_item_call);
		order = (TextView) v.findViewById(R.id.balloon_item_order);
